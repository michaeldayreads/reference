- Python For Informatics (_in progress_)
    ...
    [4. Functions](https://github.com/michaeldayreads/0_autodidact/wiki/0.PythonForInformatics.ch3-and-beyond#chapter-4-functions)
    [5. Iterations](https://github.com/michaeldayreads/0_autodidact/wiki/0.PythonForInformatics.ch3-and-beyond#chapter-5-iterations)